document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateThemeIcon(theme) {
    ...
    // Cambiar el icono después de un pequeño retraso y animarlo de vuelta
    setTimeout(() => {
      if (theme === "dark") {
  ...
  function animateThemeChange() {
    ...
    overlay.style.backgroundColor = body.classList.contains("dark-mode") ? "#0a1929" : "#ffffff" // Cambiado a azul oscuro
